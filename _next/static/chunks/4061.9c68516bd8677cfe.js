(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[4061], {
    ...
    25622: function(t, e) {
        ...
        e.getPenaltyN1 = function(t) {
            ...
            for (let u = 0; u < e; u++) {
                ...
                for (let s = 0; s < e; s++) {
                    let e = t.get(u, s);
                    e === a ? o++ : (o >= 5 && (r += n.N1 + (o - 5)),
                    a = e,
                    o = 1),
                    (e = t.get(s, u)) === l ? i++ : (i >= 5 && (r += n.N1 + (i - 5)),
                    l = e,
                    i = 1)
                }
                o >= 5 && (r += n.N1 + (o - 5)),
    ...
    45016: function(t, e, n) {
        ...
        o.prototype.write = function(t) {
            ...
            r > 0 && (n = parseInt(this.data.substr(e), 10),
            t.put(n, 3 * r + 1))
        }
        ,
        t.exports = o
    ...
    10585: function(t, e, n) {
        ...
        e.create = function(t, e) {
            ...
            let E = o.M;
            return void 0 !== e && (E = o.from(e.errorCorrectionLevel, o.M),
            n = h.from(e.version),
            ...
            function(t, e, n, o) {
                ...
                let y = function(t, e, n) {
                    ...
                    let a = r.getSymbolTotalCodewords(t)
                      ...
                      , u = (a - l) * 8;
                    for (o.getLengthInBits() + 4 <= u && o.put(0, 4); o.getLengthInBits() % 8 != 0; )
                        o.putBit(0);
                ...
                return function(t, e) {
                    ...
                    for (let e = 0; e < r.length; e++) {
                        ...
                        for (let e = -1; e <= 7; e++)
                            if (!(o + e <= -1) && !(n <= o + e))
                                for (let r = -1; r <= 7; r++)
                                    i + r <= -1 || n <= i + r || (e >= 0 && e <= 6 && (0 === r || 6 === r) || r >= 0 && r <= 6 && (0 === e || 6 === e) || e >= 2 && e <= 4 && r >= 2 && r <= 4 ? t.set(o + e, i + r, !0, !0) : t.set(o + e, i + r, !1, !0))
                    }
                }(A, e),
                function(t) {
                    let e = t.size;
                ...
                function(t, e) {
                    ...
                    for (let e = 0; e < n.length; e++) {
                        ...
                        for (let e = -2; e <= 2; e++)
                            for (let n = -2; n <= 2; n++)
                                -2 === e || 2 === e || -2 === n || 2 === n || 0 === e && 0 === n ? t.set(r + e, o + n, !0, !0) : t.set(r + e, o + n, !1, !0)
                    }
                }(A, e),
                m(A, n, 0),
                e >= 7 && function(t, e) {
    ...
    56041: function(t, e, n) {
        ...
        function g(t) {
            ...
            s.isKanjiModeEnabled() ? (e = h(u.BYTE, r.BYTE, t),
            n = h(u.KANJI, r.KANJI, t)) : (e = h(u.BYTE_KANJI, r.BYTE, t),
            n = []);
        ...
        function p(t, e) {
            ...
            if ((n = r.from(e, u)) !== r.BYTE && n.bit < u.bit)
                throw Error('"' + t + '" cannot be encoded with mode ' + r.toString(n) + ".\n Suggested mode is: " + r.toString(u));
            switch (n !== r.KANJI || s.isKanjiModeEnabled() || (n = r.BYTE),
            n) {
            case r.NUMERIC:
                return new o(t);
            case r.ALPHANUMERIC:
                ...
                for (let a = 0; a < t.length; a++) {
                    ...
                    for (let t = 0; t < l.length; t++) {
                        ...
                        for (let t = 0; t < i.length; t++) {
                            let a = i[t];
                            n[a] && n[a].node.mode === s.mode ? (o[a][f] = d(n[a].lastCount + s.length, s.mode) - d(n[a].lastCount, s.mode),
                            n[a].lastCount += s.length) : (n[a] && (n[a].lastCount = s.length),
                            o[a][f] = d(s.length, s.mode) + 4 + r.getCharCountIndicator(s.mode, e))
                        }
                    }
                    i = u
                }
                ...
                if (t.length > 1)
                    return function(t, n) {
                        for (let r = 1; r <= 40; r++) {
                            ...
                            if (o <= e.getCapacity(r, n, a.MIXED))
                                return r
                        }
                    }(t, o);
                if (0 === t.length)
    ...
    97637: function(t, e, n) {
        ...
        e.render = function(t, e, n) {
            ...
            return r.qrToImageData(s.data, t, i),
            o = a,
    ...
    37568: function(t, e, n) {
        ...
        e.render = function(t, e, n) {
            let a = r.getOptions(e)
              ...
              , c = "<path " + o(a.color.dark, "stroke") + ' d="' + function(t, e, n) {
                ...
                for (let u = 0; u < t.length; u++) {
                    ...
                    s || a || (a = !0),
                    t[u] ? (l++,
                    u > 0 && s > 0 && t[u - 1] || (r += a ? i("M", s + n, .5 + f + n) : i("m", o, 0),
                    o = 0,
                    a = !1),
                    s + 1 < e && t[u + 1] || (r += i("h", l),
                    l = 0)) : o++
            ...
            return "function" == typeof n && n(null, g),
            g
        }
    },
    9283: function(t, e) {
